...
(function () {
    ...
    function montarSnapshotDashboardPdf(metricas) {
        ...
        return {
            dashboard: {
                ...
                incluir_pedidos_pendentes: incluirPedidosPendentesEl && incluirPedidosPendentesEl.checked ? "Sim" : "Não",
    ...
    var colunas = [
        ...
        {title: "Vlr. Nota (Único)", field: "valor_nota_unico", formatter: formatMoedaCell},
        {title: "Peso Bruto (Único)", field: "peso_bruto_unico"},
        {title: "Qtd. Volumes", field: "quantidade_volumes"},
        {title: "Qtd. Saída", field: "quantidade_saida"},
        {title: "Status NF-e", field: "status_nfe"},
        {title: "Apelido (Vendedor)", field: "apelido_vendedor"},
        {title: "Descrição (Tipo de Operação)", field: "operacao_descricao"},
        {title: "Descrição (Natureza)", field: "natureza_descricao"},
        {title: "Descrição (Centro de Resultado)", field: "centro_resultado_descricao"},
        {title: "Tipo de Movimento", field: "tipo_movimento"},
        {title: "Prazo Médio", field: "prazo_medio"},
        {title: "Média (Única)", field: "media_unica"},
        ...
        {title: "Descrição (Perfil)", field: "descricao_perfil"},
