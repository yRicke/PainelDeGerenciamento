...
urlpatterns = [
    ...
    path('balanco_patrimonial/<int:empresa_id>/ativos/', views_financeiro.balanco_patrimonial_ativos, name='balanco_patrimonial_ativos'),
    path('balanco_patrimonial/<int:empresa_id>/criar/', views_financeiro.criar_balanco_patrimonial_modulo, name='criar_balanco_patrimonial_modulo'),
    path('balanco_patrimonial/<int:empresa_id>/editar/<int:balanco_patrimonial_id>/', views_financeiro.editar_balanco_patrimonial_modulo, name='editar_balanco_patrimonial_modulo'),
    path('balanco_patrimonial/<int:empresa_id>/excluir/<int:balanco_patrimonial_id>/', views_financeiro.excluir_balanco_patrimonial_modulo, name='excluir_balanco_patrimonial_modulo'),
    path('balanco_patrimonial/<int:empresa_id>/ativos/criar/', views_financeiro.criar_balanco_patrimonial_ativo_modulo, name='criar_balanco_patrimonial_ativo_modulo'),
    path('balanco_patrimonial/<int:empresa_id>/ativos/editar/<int:ativo_id>/', views_financeiro.editar_balanco_patrimonial_ativo_modulo, name='editar_balanco_patrimonial_ativo_modulo'),
    path('balanco_patrimonial/<int:empresa_id>/ativos/excluir/<int:ativo_id>/', views_financeiro.excluir_balanco_patrimonial_ativo_modulo, name='excluir_balanco_patrimonial_ativo_modulo'),
    path('dre/<int:empresa_id>/', views_financeiro.dre, name='dre'),
    path('dre/<int:empresa_id>/editar/<int:dre_id>/', views_financeiro.editar_dre_modulo, name='editar_dre_modulo'),
    ...
    path('contas_bancarias/<int:empresa_id>/excluir/<int:conta_bancaria_id>/', views_parametros.excluir_conta_bancaria_modulo, name='excluir_conta_bancaria_modulo'),
    ...
    path('descricoes_bp/<int:empresa_id>/', views_parametros.descricoes_bp, name='descricoes_bp'),
    path('descricoes_bp/<int:empresa_id>/criar/', views_parametros.criar_descricao_bp_modulo, name='criar_descricao_bp_modulo'),
    path('descricoes_bp/<int:empresa_id>/editar/<int:descricao_bp_id>/', views_parametros.editar_descricao_bp_modulo, name='editar_descricao_bp_modulo'),
    path('descricoes_bp/<int:empresa_id>/excluir/<int:descricao_bp_id>/', views_parametros.excluir_descricao_bp_modulo, name='excluir_descricao_bp_modulo'),
    ...
    path('parametros_financeiro/<int:empresa_id>/', views_parametros.parametros_financeiro, name='parametros_financeiro'),
    path('parametros_financeiro/<int:empresa_id>/criar/', views_parametros.criar_parametro_margem_financeiro_modulo, name='criar_parametro_margem_financeiro_modulo'),
    path('parametros_financeiro/<int:empresa_id>/editar/<int:parametro_financeiro_id>/', views_parametros.editar_parametro_margem_financeiro_modulo, name='editar_parametro_margem_financeiro_modulo'),
    path('parametros_financeiro/<int:empresa_id>/excluir/<int:parametro_financeiro_id>/', views_parametros.excluir_parametro_margem_financeiro_modulo, name='excluir_parametro_margem_financeiro_modulo'),
